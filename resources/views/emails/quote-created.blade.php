        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #DCE6F5;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <a href="{{ env('FRONTEND_URL', 'http://localhost:3000') }}/track" style="display:inline-block;padding:14px 28px;background:#087CF0;border-radius:11px;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;">Rastrear cotización</a>
            </td>
          </tr>
          <tr>
